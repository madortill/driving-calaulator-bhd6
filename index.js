...
function onInfoClick() {
    ...
    if (!isAboutDisplayed) {
        ...
        $("#content").html('<div class="content-title">אודות</div><div class="line about"></div> <div id="about-text"><p><b>רמ"ד טי"ל</b> : רס"ם שלומי אוגרן.</p><p><b>ניהול ובקרת התהליך</b>: רס"ר שרי חזי.</p><p><b>אפיון</b>: רב"ט רוני מיליקובסקי.</p><p><b>הפקה</b>: טוראי צליל עמר.</p><p><b>עיצוב</b>: רב"ט דנה בן שימול, סמ"ר אלדר פריג, טוראי צליל עמר וטוראי פלג ברנדוין.</p><p><b>תכנות</b>: טוראי צליל עמר וסמל גילי אלבז.</p><p><b>תיקוף התוצר: </b>רב"ט גלי חיימוביץ`, רב"ט דרור אברמסון וסמל גילי אלבז</p><p><b>מומחה תוכן  </b>: רס"ר ניב קוג`מן.</p><p><b>גרסה</b>: 2.0 2024</p><p><b>מעודכן לתאריך:20.05.2025 </b></p></div>');
