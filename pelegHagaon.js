...
let genericSentences = [
    ...
    'החניכה תחל בנסיעה בת שעה לפחות בכביש יום (ציר אספלט2)',
    'לאחר החניכה נדרש לבצע מבחן שליטה בשעות היום בטרם אישור הנהג לנהיגה עצמית3',
    "ניתן לפצל את החניכה ל-2 רכבים מאותה קבוצה כאשר שעות החניכה יהיו לפחות 50% לכל כלי רכב לפחות. לדוגמה : הכשרה על האמר ודודג' 3500 יבוצע 5 שעות לכל רכב (שעה וחצי כביש יום, שעה וחצי כביש לילה, שעה שטח יום, שעה שטח לילה)4",
    'בשלב החניכה לא יסיע הנהג הנחנך יותר מנהג + חונך + נוסע עד להשלמת תהליך החניכה ואישור ק. הבב"ד לנהיגה באופן עצמאי5',
    'נהג בשירות קבע/מילואים תנאי קבע/אע"צ בגיל 24 ומעלה ובעל וותק ברישיון נהיגה אזרחי לאותה קבוצת רכב 5 שנים לפחות, יבצע מחצית משעות החניכה6',
    ...
    "בהכשרה על רכב מוגבה יש לבצע בטרם החניכה לימוד לקחים מתאונות רכב מוגבה, חניכה של קצין הרכב להכרת מאפייני ומגבלות רכב מוגבה – מרכז הכובד, סוג ההנעה, מרחק בין הסרנים והתנהגות הרכב בנסיעה (שיפועי צד, ארגז עמוס/ריק, רוח צד וכו').8",
