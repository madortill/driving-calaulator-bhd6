        ...
        "initial": {
            ...
            "multi-C1": {
                ...
                "wolf1": {
                    "extra": {
                        genericSentences: [9,11],
                        "text": 'במידה ונהג לוחם/בט"ש עבר קורס זאב מקצועי בבא"פ/בבלנ"ם יבצע מבחן שליטה בלבד'
                    }
                },
                "wolf2": {
                    "extra": {
                ...
                "tigris": {
                    "extra": {
                        genericSentences: [9,11],
                        "text": 'במידה ונהג לוחם/בט"ש עבר קורס טיגריס מקצועי בבא"פ/בבלנ"ם יבצע מבחן שליטה בלבד'
                    }
                },
                "sprinter": {
                    "extra": {
