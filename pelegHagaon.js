...
let extras = {
    "nothing": {
        "initial": {
            ...
            "passangener": {
                "extra": {
                    "text": '4 שעות יום, שעה לילה<br>במידה ולאחר ההכשרה נדרש לנהוג על רכב נוסעים אוטומטי נוסף יש לבצע הכרת הרכב בלבד<br> במידה ונדרש להכשיר נהג עם "היתר נהיגה" (רישיון אזרחי המחייב ליווי) לנהג שלא ביצע ליין נהיגה/מרכז הובלה, יבוצע לנהג 9 שעות חניכה ביום ו-3 שעות חניכה בלילה בטרם ביצוע מבחן שליטה לאישור הנהג לנהיגה עצמית'
                },
                "auto": {
                    "extra": {
...
let genericSentences = [
    ...
    'לאחר החניכה נדרש לבצע מבחן שליטה בשעות היום בטרם אישור הנהג לנהיגה עצמית',
    ...
    'בשלב החניכה לא יסיע הנהג הנחנך יותר מנהג + חונך + נוסע עד להשלמת תהליך החניכה ואישור ק. הבב"ד לנהיגה באופן עצמאי',
